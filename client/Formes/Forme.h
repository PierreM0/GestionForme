...
public:
  ...
  explicit Forme(Couleur color) : color(color){};
  ...
  /// dézoom.
  virtual void homotetie(const Point2D &point_invariant, const double &rapport) = 0;
  ...
  virtual void rotation(const Point2D &point_invariant, const double &theta) = 0;
