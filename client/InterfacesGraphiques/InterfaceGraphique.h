...
/**
 * Cette classe représente une interface graphique capable de dessiner des formes.
 */
...
public:
    ...
    /**
     * Définit la zone du monde en donnant les 2 points d'une diagonale de cette zone.
